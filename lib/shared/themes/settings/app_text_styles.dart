...
abstract class AppTextStyles {
  /// 32px, [AppColors.textLight], [FontWeight.w700]
  static final headlineLg = textTheme.headlineLarge!;

  /// 24px, [AppColors.textLight], [FontWeight.w700]
  static final headlineMd = textTheme.headlineMedium!;

  /// 18px, [AppColors.textLight], [FontWeight.w700]
  static final headlineSm = textTheme.headlineSmall!;

  /// 24px, [AppColors.textLight], [FontWeight.w500]
  static final titleLg = textTheme.titleLarge!;

  /// 20px, [AppColors.textLight], [FontWeight.w500]
  static final titleMd = textTheme.titleMedium!;

  /// 16px, [AppColors.textLight], [FontWeight.w500]
  static final titleSm = textTheme.titleSmall!;

  /// 18px, [AppColors.textLight], [FontWeight.w400]
  static final lg = textTheme.bodyLarge!;

  /// 16px, [AppColors.textLight], [FontWeight.w400]
  static final md = textTheme.bodyMedium!;

  /// 14px, [AppColors.textLight], [FontWeight.w400]
